...
print("========================================")
print('fútbol' in (juan.hobbies and pedro.hobbies))
print("========================================")
print("\n\n\n")
...
print("Ni Juan ni Pedro tienen licencia de conducir:",
    juan.tiene_licencia == False and pedro.tiene_licencia == False
)
...
print("El último libro que María ha leído es '1984' y Juan no lo ha leído aún:",
    '1984' == maria.libros_leidos[-1] and  '1984' not in juan.libros_leidos
)
...
print("María tiene licencia de conducir o ha leído 'Moby Dick', pero no ambas cosas",
    (maria.tiene_licencia == True and 'Moby Dick' not in maria.libros_leidos) or (maria.tiene_licencia == False and 'Moby Dick' in maria.libros_leidos)
)

print("Juan ha visitado España o Francia, pero no ambos",
    ('España' in juan.paises_visitados and 'Francia' not in juan.paises_visitados) or ('España' not in juan.paises_visitados and 'Francia' in juan.paises_visitados)
)
print("Pedro y Juan comparten al menos un hobby:",
    len(pedro.hobbies & juan.hobbies) >= 1
)

print("Juan y María han visitado al menos un país en común o ambos tienen el hobby de ir al cine:",
    len(juan.paises_visitados & maria.paises_visitados) >= 1 or ('cine' in (juan.hobbies and maria.hobbies))
)
